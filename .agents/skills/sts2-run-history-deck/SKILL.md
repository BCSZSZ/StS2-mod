...
description: Extract reproducible Slay the Spire 2 run-history decks for this CardValueOverlay repo. Use when Codex needs to list or reconstruct Regent A10 winning decks, floor-N decks, or local .run history decks by applying starter deck plus map-point gained/removed/transformed/upgraded card events instead of estimating from final deck contents.
---
