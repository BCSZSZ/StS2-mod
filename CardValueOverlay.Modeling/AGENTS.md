...
- Generated extraction outputs belong under `data/extracted/` or `data/generated/`; hand-authored monster move overrides and modeling calibration inputs belong under `data/manual-tags/`. Card facts should come from the parser output and source evidence, not a separate card effect override file.
