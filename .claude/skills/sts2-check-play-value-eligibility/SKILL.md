...
description: Check which Regent and Colorless card forms are eligible for direct play-value attribution in CardValueOverlay simulations. Use when Claude needs to filter candidate cards, explain excluded forms, or verify simulator support before a user-specified direct play-value estimation run.
---
