...
description: Select and persist reproducible training deck samples for CardValueOverlay StS2 value simulations. Use when Claude needs to choose deck subsets from history-analysis deck JSON, lock a random seed, or verify selected deck counts for a user-specified group such as floor8, act2Start, or final.
---
